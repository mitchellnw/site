...
of the forward and backward pass (*i.e.* computing outputs and the entropy gradient) with the superimposed model is
faster than sequentially trying each supermask learned so far.
