...
---
[Supermasks in Superposition](https://github.com/mitchellnw/supsup) is a project by 
*Mitchell Wortsman*$$^*$$,
...
In our paper we provide a more complete characterization and justification for different continual learning scenarios.
...
both entropy $$\mathcal{H}$$ and an alternative metric $$\mathcal{G}$$ described in the paper.
...
See the paper for more thorough experiments and methods, which include storing the
...
To comment raise an issue on our [github repo](https://github.com/mitchellnw/supsup).
